...
if ( ( is_shop() || is_product_category() ) && etheme_get_option( 'products_masonry',0 ) ) {
	$classes[] = 'grid-sizer';
}
...
<div <?php wc_product_cat_class( $classes, $category ); ?>
	...
	<?php if ( $category_bg_styles != '' ) : echo '<div class="category-bg" style="' . $category_bg_styles . '"></div>'; endif; ?>
