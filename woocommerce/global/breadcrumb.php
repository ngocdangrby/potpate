...
if ($l['breadcrumb'] !== 'disable' && !$l['slider']): ?>
	<div
            ...
            <?php if ( $breadcrumb_stretch != 'default' ) : ?> data-vc-full-width="true" data-vc-full-width-init="false"
            <?php endif; if ( $breadcrumb_stretch == 'full_width_content') :?>data-vc-stretch-content="true"<?php endif;?>
            <?php echo ($bread_bg) ? 'style="background-image:url('. $bread_bg .'); margin-bottom: 25px;"': '' ; ?>
    >
