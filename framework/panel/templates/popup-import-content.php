...
<div class="et_popup-import-content">
	...
	<?php if (in_array('versions-compare', $_POST['steps']) ): ?>
        ...
        ?>
        <div class="et_popup-step et_step-versions-compare hidden <?php echo $required; ?>">
            <br/><h3 class="et_step-title text-center"><?php echo esc_html__('Versions Compare','xstore'); ?></h3>

            <div class="et-message et-info et-theme-version-info" data-theme-min-version="<?php echo $THEME_MIN_VERSION; ?>">
                <?php echo $theme->name; ?> Core plugin requires the following theme: <a class="" href="https://xstore.8theme.com/update-history/" target="_blank"><strong>XStore v.{{{version}}}.</strong></a>
