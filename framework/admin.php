	...
	function etheme_load_admin_styles() {
        ...
        if ( count($xstore_branding_settings) ) {
		    ...
		    if ( $xstore_branding_settings['control_panel']['icon'] ) {
                add_filter( 'etheme_top_bar_logo', function($icon) use ($xstore_branding_settings){
                    return $xstore_branding_settings['control_panel']['icon'];
                } );
		    }
		    
		    if ( $xstore_branding_settings['control_panel']['label'] ) {
		        add_filter( 'etheme_top_bar_label', function($icon) use ($xstore_branding_settings){
                    return $xstore_branding_settings['control_panel']['label'];
                } );
		    }
