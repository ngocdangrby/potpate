...
if ( !function_exists('et_cart_checkout_breadcrumbs') ) {
	function et_cart_checkout_breadcrumbs() {
        ...
        <div class="cart-checkout-nav">
            <a href="<?php echo wc_get_cart_url(); ?>" class="<?php echo esc_attr($classes['cart']); ?>"> <?php esc_html_e('Shopping cart', 'xstore'); ?></a>

            <a href="<?php echo wc_get_checkout_url(); ?>" class="<?php echo esc_attr($classes['checkout']); ?>"> <?php esc_html_e('Checkout', 'xstore'); ?></a>

            <a href="#" class="<?php echo esc_attr($classes['order']); ?>"> <?php esc_html_e('Order status', 'xstore'); ?></a>
        </div>
...
if ( ! function_exists( 'etheme_available_variation_gallery' ) ):
	function etheme_available_variation_gallery( $available_variation, $variationProductObject, $variation ) {
		...
		if ( !get_query_var('is_single_product', ( class_exists('WooCommerce') && is_product() ) ) ) {
			return $available_variation;
		}
