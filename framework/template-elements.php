                                ...
                                <div class="product-details">
                                    ...
                                    <?php
                                        ...
                                        if ( $woocommerce_loop['show_category']) :
                                            ...
                                            if ( ! empty( $cat ) && $cat != 'auto' ) {
                                                ...
                                                echo '<span class="category">' . wc_get_product_category_list( get_the_ID(), ' ' ) . '</span>';
                                            }
                                    ...
                                    <div class="product-main-details">
                                        ...
                                        <p class="product-title">
                                            <a href="<?php echo esc_url($local_options['url']); ?>"><?php echo wp_specialchars_decode(get_the_title()); ?></a>
                                        </p>
